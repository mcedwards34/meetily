        ...
        <div
          className={`flex items-center transition-all duration-150 group ${item.type === 'folder' && depth === 0
            ...
            : `px-3 py-2 my-0.5 rounded-md text-sm ${isActive ? 'bg-blue-100 dark:bg-blue-900 text-blue-700 dark:text-blue-300 font-medium' :
              hasTranscriptMatch ? 'bg-yellow-50 dark:bg-yellow-950' : 'hover:bg-secondary'
            } cursor-pointer`
            }`}
        ...
        >
          {item.type === 'folder' ? (
            ...
            <div className="flex flex-col w-full">
              ...
              {hasTranscriptMatch && (
                <div className="mt-1 ml-8 text-xs text-muted-foreground bg-yellow-50 dark:bg-yellow-950 p-1.5 rounded border border-yellow-100 dark:border-yellow-900 line-clamp-2">
  ...
  return (
    <div className="fixed top-0 left-0 h-screen z-40">
      ...
      <button
        ...
        className="absolute -right-6 top-20 z-50 p-1 bg-card hover:bg-secondary rounded-full shadow-lg border"
        ...
        {!isCollapsed && (
          ...
          <div className="flex-shrink-0 p-2 border-t border-border">
            ...
            {betaFeatures.importAndRetranscribe && (
              <button
                onClick={() => openImportDialog()}
                className="w-full flex items-center justify-center px-3 py-2 mt-1 text-sm font-medium text-blue-900 dark:text-blue-100 bg-blue-100 dark:bg-blue-900 hover:bg-blue-200 dark:hover:bg-blue-800 rounded-lg transition-colors shadow-sm"
              >
            ...
            <button
              onClick={() => router.push('/settings')}
              className="w-full flex items-center justify-center px-3 py-1.5 mt-1 mb-1 text-sm font-medium text-secondary-foreground bg-secondary hover:bg-secondary/80 rounded-lg transition-colors shadow-sm"
            >
