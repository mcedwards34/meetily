...
export function ModelManager({
  ...
  if (error) {
    return (
      <div className={`bg-red-50 dark:bg-red-950 border border-red-200 dark:border-red-900 rounded-lg p-4 ${className}`}>
        <p className="text-sm text-red-800 dark:text-red-400">Failed to load models</p>
                ...
                <AnimatePresence>
                  {isHovered && (
                    <motion.button
                      ...
                      className="text-muted-foreground hover:text-red-600 dark:hover:text-red-400 transition-colors p-1"
          ...
          >
            <div className="flex items-center justify-between mb-2">
              ...
              <button
                ...
                className="text-xs text-muted-foreground hover:text-red-600 dark:hover:text-red-400 font-medium transition-colors px-2 py-1 rounded hover:bg-red-50 dark:hover:bg-red-950"
