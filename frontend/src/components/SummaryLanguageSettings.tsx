          ...
          return (
            ...
            >
              ...
              <button
                ...
                className={`pr-2.5 pl-0.5 py-1 leading-none ${isPinned ? 'text-blue-400 dark:text-blue-500 hover:text-blue-700 dark:hover:text-blue-300' : 'text-muted-foreground hover:text-foreground'}`}
              >
                ×
              </button>
            </span>
