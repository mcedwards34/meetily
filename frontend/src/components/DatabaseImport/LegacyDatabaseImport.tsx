        ...
        <div className="space-y-6 py-4">
          ...
          <div className="space-y-3">
            ...
            <button
              ...
              disabled={isLoading}
              className="w-full flex items-center justify-center gap-2 px-4 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 disabled:bg-muted-foreground/40 disabled:cursor-not-allowed transition-colors"
            >
          ...
          <div className="flex flex-col gap-3 pt-2">
            ...
            <button
              ...
              disabled={isLoading}
              className="w-full px-4 py-3 border-2 border-border text-foreground rounded-lg hover:bg-secondary disabled:bg-muted disabled:cursor-not-allowed transition-colors"
            >
