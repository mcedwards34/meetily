  ...
  return (
    <TooltipProvider>
      <div className="flex flex-col space-y-2">
                    ...
                    <Tooltip>
                      <TooltipTrigger asChild>
                        <button
                          ...
                          className={`w-12 h-12 flex items-center justify-center ${isStarting || isProcessing || isValidatingModel ? 'bg-muted-foreground/40' : 'bg-red-500 hover:bg-red-600'
                        ...
                        <TooltipTrigger asChild>
                          <button
                            ...
                            className={`w-10 h-10 flex items-center justify-center ${isPausing || isResuming || isStopping
                              ...
                              : 'bg-card border-2 border-border text-muted-foreground hover:border-muted-foreground hover:bg-secondary'
                      ...
                      <Tooltip>
                        <TooltipTrigger asChild>
                          <button
                            ...
                            className={`w-10 h-10 flex items-center justify-center ${isStopping || isPausing || isResuming ? 'bg-muted-foreground/40' : 'bg-red-500 hover:bg-red-600'
                              } rounded-full text-white transition-colors relative`}
                          >
                            <Square size={16} />
                            {isStopping && (
        ...
        {/* Device error alert */}
        {deviceError && (
          <Alert variant="destructive" className="mt-4 border-red-300 dark:border-red-800 bg-red-50 dark:bg-red-950">
            <AlertCircle className="h-5 w-5 text-red-600 dark:text-red-400" />
            <button
              onClick={() => setDeviceError(null)}
              className="absolute right-3 top-3 text-red-600 dark:text-red-400 hover:text-red-800 dark:hover:text-red-300 transition-colors"
              aria-label="Close alert"
            >
              <X className="h-4 w-4" />
            </button>
            <AlertTitle className="text-red-800 dark:text-red-400 font-semibold mb-2">
              {deviceError.title}
            </AlertTitle>
