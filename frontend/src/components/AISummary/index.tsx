...
export const AISummary = ({ summary, status, error, onSummaryChange, onRegenerateSummary, meeting }: Props) => {
  ...
  const renderErrorState = () => (
    <div className="w-full p-4 bg-red-50 dark:bg-red-950 border border-red-200 dark:border-red-900 rounded-lg">
  ...
  const renderLoadingState = () => (
    <div className="w-full p-4 bg-blue-50 dark:bg-blue-950 border border-blue-200 dark:border-blue-900 rounded-lg">
    ...
    <div className="relative">
      ...
      {contextMenu.visible && selectedBlocks.length > 0 && (
        ...
        >
          ...
          <button
            className="w-full px-4 py-2 text-left hover:bg-secondary text-red-600 dark:text-red-400 flex items-center space-x-2"
