  ...
  return (
    <div 
      className={`group relative min-h-[24px] flex items-start rounded transition-all duration-150 ease-in-out
        ${isSelected ? 'bg-blue-50 dark:bg-blue-950 ring-1 ring-blue-200 dark:ring-blue-900 shadow-sm' : 'hover:bg-secondary'}`}
        ...
        {showCommands && (
          ...
          >
            {filteredCommands.map((cmd, index) => (
              ...
              >
                <span className="flex-shrink-0 w-6 h-6 flex items-center justify-center bg-secondary rounded text-secondary-foreground">
                  {cmd.icon}
                </span>
