    ...
    <div className="flex-1 min-w-0 flex flex-col bg-card overflow-hidden">
      ...
      {isSummaryLoading ? (
        ...
        <div className="flex-1 overflow-y-auto min-h-0">
          {summaryResponse && (
            <div className="fixed bottom-0 left-0 right-0 bg-card shadow-lg p-4 max-h-1/3 overflow-y-auto">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="bg-card border border-border p-4 rounded-lg shadow-sm mt-4">
          ...
          {summaryStatus !== 'idle' && (
            <div className={`mt-4 p-4 rounded-lg ${summaryStatus === 'error' ? 'bg-red-100 dark:bg-red-950 text-red-700 dark:text-red-400' :
              summaryStatus === 'completed' ? 'bg-green-100 dark:bg-green-950 text-green-700 dark:text-green-400' :
